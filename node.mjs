...
var $;
(function ($) {
    class $hype_escape_map extends $hyoo_map {
        main_sub() {
            return [
                this.Pane(),
                this.Attribution()
...
//hype/escape/map/-view.tree/map.view.tree.ts
;
"use strict";
var $;
(function ($) {
...
//hype/escape/map/map.view.ts
;
"use strict";
var $;
(function ($) {
    class $hype_escape_app extends $hype_escape_map {
    }
    $.$hype_escape_app = $hype_escape_app;
})($ || ($ = {}));
//hype/escape/app/-view.tree/app.view.tree.ts
